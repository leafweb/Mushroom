function w3CodeColor(elmnt, mode) {
  ...
  var colorObj = {
    ...
    dp: "var(--primary-30)",
    ds: "var(--secondary-30,var(--primary-30))",
    dt: "var(--tertiary-30,var(--secondary-30,var(--primary-30)))",
    dq: "var(--quaternary--30,var(--tertiary-30,var(--secondary-30,var(--primary-30))))",
    dn: "var(--neutral-30)"
  };
  var tagcolor = colorObj.dp;
  var tagnamecolor = colorObj.p;
  var attributecolor = colorObj.t;
  var attributevaluecolor = colorObj.s;
  var commentcolor = colorObj.dn;
  var cssselectorcolor = colorObj.p;
  var csspropertycolor = colorObj.t;
  var csspropertyvaluecolor = colorObj.n;
  var cssdelimitercolor = colorObj.q;
  var cssimportantcolor = colorObj.s;
  var jscolor = colorObj.n;
  var jskeywordcolor = colorObj.p;
  var jsstringcolor = colorObj.s;
  var jsnumbercolor = colorObj.t;
  var jspropertycolor = colorObj.q;
